...
But seriously, why are you even reading this? This is just a personal fun project, born of frustration with most of the tooling I've encountered in various workplaces, and a wish to see how simple and lightweight implementation for all the usual tooling.

**[Note: the following is probably obsolete in the age of AI-powered development]**
